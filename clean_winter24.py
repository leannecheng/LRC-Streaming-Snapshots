...
def clean_winter24_streaming(input_path: str, output_path: str):
    """
    Reads the 'RAW' sheet from Copy of Wn24Streaming.xlsx, cleans and aggregates:
    ...
    Writes out a new Excel file with a sheet named 'Winter 2024'.
    """
    # 1. Load RAW sheet
    ...
    # 4. Drop rows where Course contains "testcourse"
    ...
    for (instr, course, section), group in grouped:
        ...
        # c) First non-null Enrollment or 0, stripping digits
    ...
    # 6. Write to new Excel file with sheet named "Winter 2024"
    with pd.ExcelWriter(output_path, engine="openpyxl") as writer:
        clean_df.to_excel(writer, sheet_name="Winter 2024", index=False)

    print(f"✅ Cleaned data written to '{output_path}' (sheet='Winter 2024')")


if __name__ == "__main__":
    input_file = "Copy of Wn24Streaming.xlsx"
    output_file = "Winter 2024.xlsx"
    clean_winter24_streaming(input_file, output_file)
    print("All done!")
